...
Information supplémentaire: -sous, windows, l'option graphique du solver ne fonctionne pas lorsque vous utilisez la première méthode donnée.
			    -sous windows, la création de l'arbre ne se fait pas automatiquement dans le module graphique, il faut utiliser la ligne de commande suivante: dot -Tpng -o arbre.png arbre.dot
